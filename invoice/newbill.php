    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                $sql = "insert into bill(first_name,other_names,course,tfees,hfees,lfees)
                ...
                if(mysqli_query($conn,$sql) == true){
                    ...
                    print "<a href='bill.php' class='btn btn-outline-primary'>Add New</a>";
                }
                else{
                    print "<p>Bill staff not added</p>";
                    print "<a href='bill.php' class='btn btn-outline-danger'>Try Again</a>";
                }
