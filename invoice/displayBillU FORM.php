    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input value="<?php print $row['invoice_number'];?>" type="number" name="inno" hidden class="form-control" required id="">
                    <label for="" hidden><b>Invoice Date</b></label>
                    ...
                    <div class="buttons">
                        ...
                        &nbsp;
                        <a href="searchBillU FORM.php" class="btn btn-dark">Cancel Update</a>
                    </div>
                </form>
            </div>
            <div class="col-md-3"></div>
